...
const Donate = () => {
    ...
    const fetchCampaigns = async () => {
      try {
        ...
        const url = initialReferralCode
          ? `https://backend-intern-bbjb.onrender.com/api/donate/${encodeURIComponent(initialReferralCode)}`
          : "https://backend-intern-bbjb.onrender.com/api/donate/public";
  ...
  const handleDonate = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://backend-intern-bbjb.onrender.com/api/donate", {
        method: "POST",
      ...
      const options = {
        ...
        handler: async (response) => {
          const verifyResponse = await fetch("https://backend-intern-bbjb.onrender.com/api/donate/verify", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
