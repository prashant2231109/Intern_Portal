...
const InternsList = () => {
  ...
  useEffect(() => {
    const fetchInterns = async () => {
      try {
        const response = await fetch("https://backend-intern-bbjb.onrender.com/api/users", {
          method: "GET",
          headers: {
            ...
            internList.map(async (intern) => {
              try {
                const donationsResponse = await fetch(
                  `https://backend-intern-bbjb.onrender.com/api/donations/by-referral/${intern.referralCode}`,
                  {
                    headers: {
                      Authorization: `Bearer ${token}`,
                    },
  ...
  const handleAddIntern = async () => {
    ...
    try {
      ...
      const response = await fetch("https://backend-intern-bbjb.onrender.com/api/auth/signup", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleEditConfirm = async () => {
    ...
    try {
      const response = await fetch(
        `https://backend-intern-bbjb.onrender.com/api/users/${selectedIntern._id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
