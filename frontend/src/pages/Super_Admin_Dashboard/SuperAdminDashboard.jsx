...
const SuperAdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      ...
      setIsLoading(true);
      try {
        const response = await fetch("https://backend-intern-bbjb.onrender.com/api/auth/user", {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      ...
      try {
        ...
        const campaignsRes = await fetch("https://backend-intern-bbjb.onrender.com/api/campaign", {
          headers: { Authorization: `Bearer ${token}` },
        });
        const campaignsData = await campaignsRes.json();
        // Fetch interns count
        const internsRes = await fetch("https://backend-intern-bbjb.onrender.com/api/users", {
          headers: { Authorization: `Bearer ${token}` },
        });
        const internsData = await internsRes.json();
        // Fetch donations sum
        const donationsRes = await fetch("https://backend-intern-bbjb.onrender.com/api/donations", {
          headers: { Authorization: `Bearer ${token}` },
        });
